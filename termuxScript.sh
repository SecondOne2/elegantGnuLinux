...
declare -a necessary=(python tmux wget file tar zip dnsutils mlocate nmap python golang man littlecms git binutils proot radare2 nano dropbear cronie bash-completion pip33 eg tldr ipython)
